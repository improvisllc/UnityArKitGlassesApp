...
public class MainController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //m_aRFace.GetComponent<MeshRenderer>().enabled = false;
    }
...
/// ///////////////////////////////////////////////////////
    ...
    void fitGlasses()
    {
        ...
        /*m_facePoints[848].GetComponent<MeshRenderer>().material.color = Color.red;

        m_facePoints[1134].GetComponent<MeshRenderer>().material.color = Color.red;
        m_facePoints[607].GetComponent<MeshRenderer>().material.color = Color.red;*/
        ...
        GameObject clmEarPointLeft = m_facePoints[489];
        GameObject clmEarPointRight = m_facePoints[467];

        if(templeRotPointL == null || templeRotPointR == null)
        {
            print("Garik templeRotPointL or templeRotPointR IS NULL");
        }

        if (earpieceEndPointL == null || earpieceEndPointR == null)
        {
            print("Garik earpieceEndPointL or earpieceEndPointR IS NULL");
        }

        if (clmEarPointLeft == null || clmEarPointRight == null)
        {
            print("Garik clmEarPointLeft or clmEarPointRight IS NULL");
        }
    ...
    public float getScaleOfGlassesObject(List<GameObject> points, GameObject originalObject)
    {
        ...
        Vector3 a = originalObject.transform.GetChild(0).transform.Find(Constants.s_templeRotPointLName).transform.localPosition;
        Vector3 b = originalObject.transform.GetChild(0).transform.Find(Constants.s_templeRotPointRName).transform.localPosition;
